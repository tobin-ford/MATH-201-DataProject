...
$$H_a: \rho > 0 \text{ (Positive association between the percent in poverty and the percent of the population in school).}$$
...
To test the hypothesis we performed a correlation test for correlation. The resulting $R^2$ value was 0.02201, and the resulting p-value was 0. The percentage in poverty accounts for 2.201% of the variability in the percent of the population in school. There is sufficient evidence that there is a positive association between the percent of a neighborhood in poverty and the percent of the population in school.
