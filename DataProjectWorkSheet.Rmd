...
unique(RawData$offense_type_id)
...
violent_crimes <- c("assault-simple", "weapon-unlawful-discharge-of", "menacing-felony-w-weap", "agg-aslt-shoot",
                    ...
                    "arson-business", "arson-residence", "arson-vehicle", "arson-other", "arson-public-building",
                    "sexual-assault", "rape", "homicide-family", "false-imprisonment", "weapon-fire-into-occ-bldg", "weapon-fire-into-occ-veh",
...
RawData$violent <- sapply(RawData$offense_type_id, categorize_crime)
